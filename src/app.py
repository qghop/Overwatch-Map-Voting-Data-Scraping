...
parser.add_argument('--start-date', type=str, default="2025-07-01", help="Start date (Midnight UTC) in YYYY-MM-DD")
parser.add_argument('--end-date', type=str, default="2025-07-02", help="End date (Midnight UTC) in YYYY-MM-DD")
